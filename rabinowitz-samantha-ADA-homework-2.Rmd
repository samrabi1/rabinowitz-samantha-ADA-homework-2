...
sample1_stats <- sample1 %>% summarize_if(is.numeric, list(mean=mean,sd=sd, se=std_error))
sample1_stats %>% glimpse()
ci_height <- sample1_stats$height_mean + c(-1, 1) * qt(1 - 0.05 / 2, df = 30 - 1) * sample1_stats$height_se
ci_height
ci_weight <- sample1_stats$weight_mean + c(-1, 1) * qt(1 - 0.05 / 2, df = 30 - 1) * sample1_stats$weight_se
ci_weight
ci_zombies_killed <- sample1_stats$zombies_killed_mean + c(-1, 1) * qt(1 - 0.05 / 2, df = 30 - 1) * sample1_stats$zombies_killed_se
ci_zombies_killed
ci_years_of_education <- sample1_stats$years_of_education_mean + c(-1, 1) * qt(1 - 0.05 / 2, df = 30 - 1) * sample1_stats$years_of_education_se
ci_years_of_education
ci_age <- sample1_stats$age_mean + c(-1, 1) * qt(1 - 0.05 / 2, df = 30 - 1) * sample1_stats$age_se
ci_age
```
